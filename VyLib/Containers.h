...
#include "VyLib/Exceptions.h"
#include "VyLib/Pointers.h"
...
/// @brief Describes an intermediate container for elements of type T.
...
#pragma region Covariant

/// @brief Evaluates if a type TCovariant behaves covariant to a value type TValue.
///        In this context, covariance is expressed as the type.
///        TCovariant can be assigned a value of type TValue or can be constructed from a value of TValue.
/// @tparam TValue     - The type of the value.
/// @tparam TCovariant - The covariant type to check against TValue.
...
/// @brief Evaluates if if an iterator of type TIterator iterates values that are covariant to TValue.
